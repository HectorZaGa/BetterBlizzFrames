...
-- Export helpers and variables to BBF namespace
...
BBF.checkBoxList = checkBoxList
BBF.sliderList = sliderList
...
BBF.GeneratorFunction = GeneratorFunction
BBF.GetLocalizedText = GetLocalizedText
BBF.HandleEditBoxInput = HandleEditBoxInput
BBF.HideWipeButton = HideWipeButton
BBF.OpenColorOptions = OpenColorOptions
BBF.OpenColorPicker = OpenColorPicker
BBF.RecolorEntireAuraWhitelist = RecolorEntireAuraWhitelist
BBF.SearchElements = SearchElements
BBF.SetChecked = SetChecked
BBF.SetImportantBoxColor = SetImportantBoxColor
BBF.SetSliderValue = SetSliderValue
BBF.SetTextColor = SetTextColor
BBF.ShowProfileConfirmation = ShowProfileConfirmation
BBF.UpdateColorSquare = UpdateColorSquare
BBF.UpdateIconTexture = UpdateIconTexture
BBF.UpdateOption = UpdateOption
BBF.UpdateSliderRange = UpdateSliderRange
BBF.addOrUpdateEntry = addOrUpdateEntry
BBF.applyRightClickScript = applyRightClickScript
BBF.cancelFunc = cancelFunc
BBF.cleanUpEntry = cleanUpEntry
BBF.createOrUpdateTextLineButton = createOrUpdateTextLineButton
BBF.deleteEntry = deleteEntry
BBF.formatSliderValue = formatSliderValue
BBF.getDisplayTextForSetting = getDisplayTextForSetting
BBF.getSortedNpcList = getSortedNpcList
BBF.matchesQuery = matchesQuery
BBF.opacityFunc = opacityFunc
BBF.processNextBatch = processNextBatch
BBF.refreshList = refreshList
BBF.searchList = searchList
BBF.swatchFunc = swatchFunc
