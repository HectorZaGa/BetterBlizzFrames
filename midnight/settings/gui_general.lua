...
function guiGeneralTab()
    ...
    AddCardDualChildCheckboxes(cardGen, cbBoss, "hideBossFramesParty", L["Party"], L["Tooltip_Hide_Boss_Frames_Party"], "hideBossFramesRaid", L["Raid"], L["Tooltip_Hide_Boss_Frames_Raid"])
    ...
    AddCardCheckbox(cardPlayerFX, "hideFullPower", L["Tooltip_Hide_Full_Mana_FX"], L["Tooltip_Hide_Full_Mana_FX_Desc"], BBF.HideFrames)
    ...
    AddCardChildCheckbox(cardAllDisp, cbFormatNum, "singleValueStatusBarText", L["No_Max_Value"], L["Tooltip_No_Max_Desc"])
