            ...
            cards       = {
                {
                    ...
                    options = {
                        ...
                        { type="checkbox", key="playerCastBarTimer", label=L["Timer"],        tooltip=L["Tooltip_Castbar_Timer"], onChange=BBF.CastBarTimerCaller },
                        { type="checkbox", key="playerDetachCastbar",label=L["Castbar_Detach"],tooltip=L["Tooltip_Detach_From_Frame"] },
                        { type="checkbox", key="hidePlayerCastbar",  label=L["Hide_Bar"],      tooltip=L["Hide_Player_Castbar"], onChange=BBF.ChangeCastbarSizes },
                        { type="checkbox", key="hidePlayerCastbarIcon", label=L["Hide_Icon"],  tooltip=L["Hide_Player_Castbar_Icon"], onChange=BBF.ChangeCastbarSizes },
                    }
                }
            }
        },
